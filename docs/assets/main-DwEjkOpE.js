import{a as kt,E as yt,B as wt,b as xt,e as lt,u as q,T as zt,w as ot,i as Dt,q as dt,n as Me,s as _t,c as Et,d as Pt,r as Lt,S as Mt,f as St,g as $e,h as Ce,j,k as x,l as oe,m,p as O,o as Ue,t as N,v as de,x as i,y as r,z as Ee,A as n,C as A,D as Pe,F as R,G as S,H as Q,I as pe,J as $t,K as ye,L as Ve,M as se,N as M,O as ge,P as re,Q as qe,R as Se,$ as Ct,U as Ne,V as At,W as X,X as It}from"./legacy-C0Jhm6HA.js";import{o as Ke,c as ct,a as Ye}from"./case-studies-B6ddyGcR.js";import{i as J}from"./if-BeITjswG.js";import{s as Le}from"./style-CVi7sZUO.js";import{h as Ft}from"./html-Rx8xiX3v.js";import{g as Tt}from"./glossary-CgJV2LYV.js";import{g as et}from"./bibliography-CjHawp0Z.js";const qt=()=>performance.now(),he={tick:s=>requestAnimationFrame(s),now:()=>qt(),tasks:new Set};function ut(){const s=he.now();he.tasks.forEach(e=>{e.c(s)||(he.tasks.delete(e),e.f())}),he.tasks.size!==0&&he.tick(ut)}function Vt(s){let e;return he.tasks.size===0&&he.tick(ut),{promise:new Promise(t=>{he.tasks.add(e={c:s,f:t})}),abort(){he.tasks.delete(e)}}}function Te(s,e){ot(()=>{s.dispatchEvent(new CustomEvent(e))})}function Kt(s){if(s==="float")return"cssFloat";if(s==="offset")return"cssOffset";if(s.startsWith("--"))return s;const e=s.split("-");return e.length===1?e[0]:e[0]+e.slice(1).map(t=>t[0].toUpperCase()+t.slice(1)).join("")}function tt(s){const e={},t=s.split(";");for(const a of t){const[o,d]=a.split(":");if(!o||d===void 0)break;const l=Kt(o.trim());e[l]=d.trim()}return e}const Rt=s=>s;function b(s,e,t,a){var o=(s&Et)!==0,d=(s&Pt)!==0,l=o&&d,u=(s&zt)!==0,h=l?"both":o?"in":"out",g,v=e.inert,p=e.style.overflow,c,f;function k(){return ot(()=>g??=t()(e,a?.()??{},{direction:h}))}var w={is_global:u,in(){if(e.inert=v,!o){f?.abort(),f?.reset?.();return}d||c?.abort(),Te(e,"introstart"),c=Ge(e,k(),f,1,()=>{Te(e,"introend"),c?.abort(),c=g=void 0,e.style.overflow=p})},out(D){if(!d){D?.(),g=void 0;return}e.inert=!0,Te(e,"outrostart"),f=Ge(e,k(),c,0,()=>{Te(e,"outroend"),D?.()})},stop:()=>{c?.abort(),f?.abort()}},z=kt;if((z.nodes.t??=[]).push(w),o&&_t){var $=u;if(!$){for(var E=z.parent;E&&(E.f&yt)!==0;)for(;(E=E.parent)&&(E.f&wt)===0;);$=!E||(E.f&xt)!==0}$&&lt(()=>{q(()=>w.in())})}}function Ge(s,e,t,a,o){var d=a===1;if(Dt(e)){var l,u=!1;return dt(()=>{if(!u){var z=e({direction:d?"in":"out"});l=Ge(s,z,t,a,o)}}),{abort:()=>{u=!0,l?.abort()},deactivate:()=>l.deactivate(),reset:()=>l.reset(),t:()=>l.t()}}if(t?.deactivate(),!e?.duration)return o(),{abort:Me,deactivate:Me,reset:Me,t:()=>a};const{delay:h=0,css:g,tick:v,easing:p=Rt}=e;var c=[];if(d&&t===void 0&&(v&&v(0,1),g)){var f=tt(g(0,1));c.push(f,f)}var k=()=>1-a,w=s.animate(c,{duration:h,fill:"forwards"});return w.onfinish=()=>{w.cancel();var z=t?.t()??1-a;t?.abort();var $=a-z,E=e.duration*Math.abs($),D=[];if(E>0){var I=!1;if(g)for(var C=Math.ceil(E/16.666666666666668),T=0;T<=C;T+=1){var B=z+$*p(T/C),W=tt(g(B,1-B));D.push(W),I||=W.overflow==="hidden"}I&&(s.style.overflow="hidden"),k=()=>{var V=w.currentTime;return z+$*p(V/E)},v&&Vt(()=>{if(w.playState!=="running")return!1;var V=k();return v(V,1-V),!0})}w=s.animate(D,{duration:E,fill:"forwards"}),w.onfinish=()=>{k=()=>a,v?.(a,1-a),o()}},{abort:()=>{w&&(w.cancel(),w.effect=null,w.onfinish=Me)},deactivate:()=>{o=Me},reset:()=>{a===0&&v?.(1,0)},t:()=>k()}}function nt(s,e){return s===e||s?.[Mt]===e}function He(s={},e,t,a){return lt(()=>{var o,d;return Lt(()=>{o=d,d=[],q(()=>{s!==t(...d)&&(e(s,...d),o&&nt(t(...o),s)&&e(null,...o))})}),()=>{dt(()=>{d&&nt(t(...d),s)&&e(null,...d)})}}),s}function Bt(s){return function(...e){var t=e[0];return t.stopPropagation(),s?.apply(this,e)}}function Wt(s,e){var t=s.$$events?.[e.type],a=St(t)?t.slice():t==null?[]:[t];for(var o of a)o.call(this,e)}const fe=Ce(0),we=Ce(0),ne=[{id:"intro",label:"Promptotyping",number:null,subtitle:"Einführung",steps:[{id:"definition",label:"Definition"},{id:"vibecoding",label:"Vibe Coding"},{id:"strangeminds",label:"Strange New Minds"},{id:"kernprinzip",label:"Kernprinzip"},{id:"methodik",label:"Methodik"},{id:"phasen",label:"Phasen"}]},{id:"phase1",label:"Preparation",number:1,subtitle:"Materialsammlung",steps:[{id:"titel",label:"Übersicht"},{id:"rohdaten",label:"Rohdaten"},{id:"sammlung",label:"Sammlung"}]},{id:"phase2",label:"Exploration",number:2,subtitle:"Daten-Kontext-Relationen",steps:[{id:"exploration",label:"Exploration"}]},{id:"phase3",label:"Destillation",number:3,subtitle:"Vault (.md Files)",steps:[{id:"titel",label:"Übersicht"},{id:"dokumente",label:".md Dokumente"},{id:"vault",label:"Vault"}]},{id:"phase4",label:"Implementation",number:4,subtitle:"Prototype + Vault-Update",steps:[{id:"titel",label:"Übersicht"},{id:"iteration",label:"Iteration"},{id:"vault-update",label:"Vault-Update"}]},{id:"outro",label:"Praxis",number:null,subtitle:"Case Studies & Reflexion",steps:[{id:"beispiele",label:"Beispiele"},{id:"diskussion",label:"Diskussion"},{id:"zusammenfassung",label:"Zusammenfassung"}]}],jt=ne.reduce((s,e)=>s+e.steps.length,0),Ot=$e([fe,we],([s,e])=>{let t=0;for(let a=0;a<s;a++)t+=ne[a].steps.length;return t+e}),Nt=$e(Ot,s=>s/(jt-1));$e([fe,we],([s,e])=>{const t=ne[s];return!t||t.steps.length<=1?0:e/(t.steps.length-1)});$e(fe,s=>ne[s]||ne[0]);$e([fe,we],([s,e])=>{const t=ne[s];return t?t.steps[e]||t.steps[0]:null});ne.map((s,e)=>({id:s.id,label:s.label,steps:s.steps.map(t=>t.id)}));const st=Ce(!1);function Gt(){if(typeof window<"u"){const s=window.matchMedia("(prefers-reduced-motion: reduce)");st.set(s.matches),s.addEventListener("change",e=>{st.set(e.matches)})}}function it(s){if(typeof window>"u")return;const e=document.getElementById(s);e&&e.scrollIntoView({behavior:"smooth"})}function Oe(){if(typeof window>"u")return;const s=window.location.hash.slice(1);if(!s)return;const e=document.getElementById(s);if(e){setTimeout(()=>{e.scrollIntoView({behavior:"smooth"})},100);return}const t=s.split("-"),a=t[0],o=t.slice(1).join("-"),d=ne.findIndex(h=>h.id===a);if(d===-1)return;const l=ne[d];let u=a;o?l.steps.some(g=>g.id===o)&&(u=`${a}-${o}`):u=`${a}-${l.steps[0].id}`,setTimeout(()=>{const h=document.getElementById(u);h&&h.scrollIntoView({behavior:"smooth"})},100)}let rt="";function Ht(s,e){if(typeof window>"u")return;const t=ne[s];if(!t)return;const a=t.steps[e],o=a?`${t.id}-${a.id}`:t.id;o!==rt&&(rt=o,history.replaceState(null,"",`#${o}`))}const Ut={"system-1-42":{id:"system-1-42",title:"System 1.42 – Wie LLMs funktionieren",content:`
    ...
    `}},Ze=Ce(null),Xe=Ce(!1);function xe(s){const e=Ut[s];e?(Ze.set(e),Xe.set(!0),document.body.style.overflow="hidden"):console.warn(`Deep Dive not found: ${s}`)}function Zt(){Xe.set(!1),setTimeout(()=>{Ze.set(null)},300),document.body.style.overflow=""}var Xt=$t('<svg class="check-icon svelte-baj8t4" viewBox="0 0 12 12" fill="none"><path d="M2 6L5 9L10 3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>'),Qt=x('<span class="phase-number svelte-baj8t4"> </span>'),Jt=x('<button><span class="step-dot-marker svelte-baj8t4"></span> <span class="step-label svelte-baj8t4"> </span></button>'),Yt=x('<div class="sub-steps svelte-baj8t4"></div>'),en=x('<li class="phase-item svelte-baj8t4"><button><span class="dot svelte-baj8t4"><!></span> <span class="label-container svelte-baj8t4"><span class="label svelte-baj8t4"> </span> <!></span></button> <!></li>'),tn=x('<nav class="progress-indicator svelte-baj8t4" aria-label="Phasen-Navigation"><ul class="svelte-baj8t4"></ul></nav>');function nn(s,e){N(e,!1);const t=()=>pe(fe,"$currentPhase",o),a=()=>pe(we,"$currentStep",o),[o,d]=Ue();function l(p){const c=ne[p],f=`${c.id}-${c.steps[0].id}`;it(f)}function u(p,c){const f=ne[p],k=f.steps[c],w=`${f.id}-${k.id}`;it(w)}function h(p,c){(p.key==="Enter"||p.key===" ")&&(p.preventDefault(),l(c))}j();var g=tn(),v=i(g);oe(v,5,()=>ne,de,(p,c,f)=>{const k=Ee(()=>t()===f),w=Ee(()=>t()>f);var z=en(),$=i(z);let E;var D=i($),I=i(D);{var C=P=>{var Z=Xt();m(P,Z)};J(I,P=>{r(w)&&P(C)})}var T=n(D,2),B=i(T),W=i(B),V=n(B,2);{var ie=P=>{var Z=Qt(),K=i(Z);A(()=>S(K,`Phase ${r(c).number??""}`)),m(P,Z)};J(V,P=>{r(c).number&&P(ie)})}var ae=n($,2);{var ue=P=>{var Z=Yt();oe(Z,5,()=>r(c).steps,de,(K,le,ce)=>{const ve=Ee(()=>a()===ce),ze=Ee(()=>a()>ce);var G=Jt();let ee;var De=n(i(G),2),_e=i(De);A(()=>{ee=Pe(G,1,"step-dot svelte-baj8t4",null,ee,{active:r(ve),completed:r(ze)}),R(G,"aria-label",`Zu ${r(le).label??""} springen`),S(_e,r(le).label)}),Q("click",G,()=>u(f,ce)),m(K,G)}),m(P,Z)};J(ae,P=>{r(k)&&P(ue)})}A(()=>{E=Pe($,1,"progress-dot svelte-baj8t4",null,E,{active:r(k),completed:r(w)}),R($,"aria-label",`Zu ${r(c).label??""} springen`),R($,"aria-current",r(k)?"step":void 0),S(W,r(c).label)}),Q("click",$,()=>l(f)),Q("keydown",$,P=>h(P,f)),m(p,z)}),m(s,g),O(),d()}var sn=x('<span class="phase-number svelte-1yliotu"> </span>'),rn=x('<span class="phase-tag svelte-1yliotu"> </span>'),an=x('<span class="step-separator svelte-1yliotu">—</span> <span class="current-step svelte-1yliotu"> </span>',1),ln=x('<header class="phase-header svelte-1yliotu"><div class="header-content svelte-1yliotu"><div class="phase-badge svelte-1yliotu"><!></div> <div class="title-group svelte-1yliotu"><h2 class="phase-title svelte-1yliotu"> </h2> <!></div> <nav class="header-nav svelte-1yliotu"><a href="/PromptotypingExplainer/about.html" class="nav-link svelte-1yliotu">About</a> <a href="/PromptotypingExplainer/vault.html" class="nav-link svelte-1yliotu">Vault</a> <a href="/PromptotypingExplainer/glossar.html" class="nav-link svelte-1yliotu">Glossar</a> <a href="/PromptotypingExplainer/bibliographie.html" class="nav-link svelte-1yliotu">Bibliographie</a></nav></div></header>');function on(s,e){N(e,!1);const t=()=>pe(fe,"$currentPhase",o),a=()=>pe(we,"$currentStep",o),[o,d]=Ue(),l=se(),u=se();ye(()=>t(),()=>{M(l,ne[t()]||ne[0])}),ye(()=>(r(l),a()),()=>{M(u,r(l).steps[a()]||r(l).steps[0])}),Ve(),j();var h=ln(),g=i(h),v=i(g),p=i(v);{var c=D=>{var I=sn(),C=i(I);A(()=>S(C,`Phase ${r(l),q(()=>r(l).number)??""}`)),m(D,I)},f=D=>{var I=rn(),C=i(I);A(()=>S(C,(r(l),q(()=>r(l).subtitle)))),m(D,I)};J(p,D=>{r(l),q(()=>r(l).number)?D(c):D(f,!1)})}var k=n(v,2),w=i(k),z=i(w),$=n(w,2);{var E=D=>{var I=an(),C=n(ge(I),2),T=i(C);A(()=>S(T,(r(u),q(()=>r(u).label)))),m(D,I)};J($,D=>{r(u)&&D(E)})}A(()=>S(z,(r(l),q(()=>r(l).label)))),m(s,h),O(),d()}var dn=x('<section class="step svelte-zv7veq"><div class="step-content svelte-zv7veq"><!></div></section>');function U(s,e){N(e,!1);let t=re(e,"id",8),a=re(e,"phaseIndex",8),o=re(e,"stepIndex",8),d=se();Ke(()=>{const g=new IntersectionObserver(v=>{v.forEach(p=>{p.isIntersecting&&p.intersectionRatio>.5&&(we.set(o()),fe.set(a()))})},{threshold:.5,rootMargin:"-10% 0px -10% 0px"});return g.observe(r(d)),()=>g.disconnect()}),j();var l=dn(),u=i(l),h=i(u);qe(h,e,"default",{},null),He(l,g=>M(d,g),()=>r(d)),A(()=>{R(l,"id",t()),R(l,"data-phase",a()),R(l,"data-step",o())}),m(s,l),O()}const cn=s=>s;function vt(s){const e=s-1;return e*e*e+1}function at(s){const e=typeof s=="string"&&s.match(/^\s*(-?[\d.]+)([^\s]*)\s*$/);return e?[parseFloat(e[1]),e[2]||"px"]:[s,"px"]}function _(s,{delay:e=0,duration:t=400,easing:a=cn}={}){const o=+getComputedStyle(s).opacity;return{delay:e,duration:t,easing:a,css:d=>`opacity: ${d*o}`}}function F(s,{delay:e=0,duration:t=400,easing:a=vt,x:o=0,y:d=0,opacity:l=0}={}){const u=getComputedStyle(s),h=+u.opacity,g=u.transform==="none"?"":u.transform,v=h*(1-l),[p,c]=at(o),[f,k]=at(d);return{delay:e,duration:t,easing:a,css:(w,z)=>`
			transform: ${g} translate(${(1-w)*p}${c}, ${(1-w)*f}${k});
			...
			opacity: ${u-v*c}
		`}}var un=x('<div class="deep-dive-overlay svelte-tewam" role="dialog" aria-modal="true" aria-labelledby="deep-dive-title" tabindex="-1"><div class="deep-dive-panel svelte-tewam"><header class="panel-header svelte-tewam"><div class="header-indicator svelte-tewam"><span class="branch-icon svelte-tewam">←</span> <span class="branch-label svelte-tewam">Deep Dive</span></div> <h2 id="deep-dive-title" class="svelte-tewam"> </h2> <button class="close-button svelte-tewam" aria-label="Schließen">×</button></header> <div class="panel-content svelte-tewam"><!></div> <footer class="panel-footer svelte-tewam"><button class="back-button svelte-tewam">→ Zurück zum Hauptpfad</button></footer></div></div>');function vn(s,e){N(e,!1);let t=re(e,"isOpen",8,!1),a=re(e,"title",8,""),o=re(e,"content",8,null);const d=ct();function l(){d("close")}function u(c){c.key==="Escape"&&l()}function h(c){c.target===c.currentTarget&&l()}j();var g=Se();Q("keydown",Ct,u);var v=ge(g);{var p=c=>{var f=un(),k=i(f),w=i(k),z=n(i(w),2),$=i(z),E=n(z,2),D=n(w,2),I=i(D);{var C=V=>{var ie=Se(),ae=ge(ie);Ft(ae,o),m(V,ie)},T=V=>{var ie=Se(),ae=ge(ie);qe(ae,e,"default",{},null),m(V,ie)};J(I,V=>{o()?V(C):V(T,!1)})}var B=n(D,2),W=i(B);A(()=>S($,a())),Q("click",E,l),Q("click",W,l),b(3,k,()=>F,()=>({x:-300,duration:300})),b(3,f,()=>_,()=>({duration:200})),Q("click",f,h),m(c,f)};J(v,c=>{t()&&c(p)})}m(s,g),O()}var pn=x('<div class="lock-progress svelte-l7i3p6"></div>'),hn=x('<button class="lock-indicator svelte-l7i3p6" title="Klicken zum Schließen"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg></button>'),gn=x('<span class="popover-en svelte-l7i3p6"> </span>'),mn=x('<span class="tag svelte-l7i3p6"> </span>'),fn=x('<a class="popover-source svelte-l7i3p6"> </a>'),bn=x('<div role="tooltip"><div class="caret svelte-l7i3p6"></div> <!> <!> <div class="popover-header svelte-l7i3p6"><span class="popover-term svelte-l7i3p6"> </span> <!></div> <p class="popover-definition svelte-l7i3p6"> </p> <div class="popover-footer svelte-l7i3p6"><div class="popover-tags svelte-l7i3p6"></div> <!></div></div>'),kn=x('<span role="button" tabindex="0"><!></span><!>',1);function Y(s,e){N(e,!1);const t=se(),a=se();let o=re(e,"id",8),d=re(e,"inline",8,!0),l=se(!1),u=se(!1),h=se(!1),g=se(),v=se(),p,c,f=se({top:0,left:0,placement:"above"});const k=800;async function w(){if(await At(),!r(g))return;const P=r(g).getBoundingClientRect(),Z=200,K=8;let le,ce,ve="above";P.top>Z+K?(le=P.top-K,ve="above"):(le=P.bottom+K,ve="below"),ce=P.left+P.width/2,M(f,{top:le,left:ce,placement:ve})}function z(){r(u)||(p=setTimeout(()=>{M(l,!0),M(h,!0),w(),c=setTimeout(()=>{M(u,!0),M(h,!1)},k)},200))}function $(){clearTimeout(p),clearTimeout(c),r(u)||(M(l,!1),M(h,!1))}function E(P){P.preventDefault(),P.stopPropagation(),clearTimeout(p),clearTimeout(c),r(u)?(M(u,!1),M(l,!1),M(h,!1)):(M(l,!0),M(u,!0),M(h,!1),w())}function D(){clearTimeout(p),clearTimeout(c)}function I(){r(u)||(M(l,!1),M(h,!1))}function C(P){r(l)&&r(g)&&!r(g).contains(P.target)&&r(v)&&!r(v).contains(P.target)&&(M(l,!1),M(u,!1),M(h,!1))}function T(){r(l)&&!r(u)&&(M(l,!1),M(h,!1),clearTimeout(c))}function B(P){P.key==="Escape"&&r(l)&&(M(l,!1),M(u,!1),M(h,!1))}Ke(()=>(document.addEventListener("click",C),window.addEventListener("scroll",T,{passive:!0}),window.addEventListener("keydown",B),window.addEventListener("resize",w),()=>{document.removeEventListener("click",C),window.removeEventListener("scroll",T),window.removeEventListener("keydown",B),window.removeEventListener("resize",w),clearTimeout(p),clearTimeout(c)}));const W={prompting:"#3B82F6","ai-engineering":"#8B5CF6",fundamentals:"#607D8B",architecture:"#059669",safety:"#DC2626",training:"#D97706",agents:"#EC4899",evaluation:"#6366F1",methodology:"#14B8A6",theory:"#8B5CF6"};ye(()=>Ne(o()),()=>{M(t,Tt[o()])}),ye(()=>(r(t),et),()=>{M(a,r(t)?.source?et(r(t).source):null)}),Ve(),j();var V=Se(),ie=ge(V);{var ae=P=>{var Z=kn(),K=ge(Z);let le;var ce=i(K);qe(ce,e,"default",{},G=>{var ee=X();A(()=>S(ee,(r(t),q(()=>r(t).term)))),m(G,ee)}),He(K,G=>M(g,G),()=>r(g));var ve=n(K);{var ze=G=>{var ee=bn();let De;var _e=n(i(ee),2);{var y=H=>{var te=pn();m(H,te)};J(_e,H=>{r(h)&&H(y)})}var L=n(_e,2);{var be=H=>{var te=hn();Q("click",te,E),m(H,te)};J(L,H=>{r(u)&&H(be)})}var Ae=n(L,2),Ie=i(Ae),Re=i(Ie),Be=n(Ie,2);{var We=H=>{var te=gn(),ke=i(te);A(()=>S(ke,`(${r(t),q(()=>r(t).en)??""})`)),m(H,te)};J(Be,H=>{r(t),q(()=>r(t).en&&r(t).en!==r(t).term&&!r(t).term.includes(r(t).en))&&H(We)})}var Fe=n(Ae,2),gt=i(Fe),mt=n(Fe,2),Je=i(mt);oe(Je,5,()=>(r(t),q(()=>r(t).tags)),de,(H,te)=>{var ke=mn(),je=i(ke);A(()=>{Le(ke,`background-color: ${r(te),q(()=>W[r(te)]||"#607D8B")??""}`),S(je,r(te))}),m(H,ke)});var ft=n(Je,2);{var bt=H=>{var te=fn(),ke=i(te);A(()=>{R(te,"href",`bibliographie.html#bibliographie-${r(a),q(()=>r(a)?.id||"")??""}`),S(ke,(r(t),q(()=>r(t).source)))}),Q("click",te,Bt(function(je){Wt.call(this,e,je)})),m(H,te)};J(ft,H=>{r(t),q(()=>r(t).source)&&H(bt)})}He(ee,H=>M(v,H),()=>r(v)),A(()=>{R(ee,"id",`tooltip-${o()??""}`),De=Pe(ee,1,"glossary-popover svelte-l7i3p6",null,De,{above:r(f).placement==="above",below:r(f).placement==="below",locked:r(u),locking:r(h)}),Le(ee,`top: ${r(f),q(()=>r(f).top)??""}px; left: ${r(f),q(()=>r(f).left)??""}px;`),S(Re,(r(t),q(()=>r(t).term))),S(gt,(r(t),q(()=>r(t).definition)))}),Q("mouseenter",ee,D),Q("mouseleave",ee,I),m(G,ee)};J(ve,G=>{r(l)&&G(ze)})}A(()=>{le=Pe(K,1,"glossary-term svelte-l7i3p6",null,le,{inline:d(),active:r(l),locked:r(u)}),R(K,"aria-describedby",r(l)?`tooltip-${o()}`:void 0),R(K,"aria-expanded",r(l))}),Q("click",K,E),Q("mouseenter",K,z),Q("mouseleave",K,$),Q("keydown",K,G=>G.key==="Enter"&&E(G)),m(P,Z)},ue=P=>{var Z=Se(),K=ge(Z);qe(K,e,"default",{},null),m(P,Z)};J(ie,P=>{r(t)?P(ae):P(ue,!1)})}m(s,V),O()}const yn="/PromptotypingExplainer/assets/promptotyping-logo-ey7SXXm7.png";var wn=x(`<div class="intro-definition svelte-10mg3y6"><div class="title-block svelte-10mg3y6"><img alt="Promptotyping Logo" class="logo svelte-10mg3y6"/> <h1 class="promptotyping-title svelte-10mg3y6">Promptotyping</h1></div> <div class="research-blog-block svelte-10mg3y6"><p class="svelte-10mg3y6"><span class="promptotyping">Promptotyping</span> ist eine strukturierte Methode zur forschungsdatengetriebenen
      ...
      Die Methode ist nicht abgeschlossen, sondern entwickelt sich mit den Möglichkeiten der Frontier-LLMs weiter.</p></div></div>`);function xn(s){var e=wn(),t=i(e),a=i(t),o=n(t,2),d=i(o),l=n(i(d),2);Y(l,{id:"llm",children:(v,p)=>{var c=X("LLMs");m(v,c)},$$slots:{default:!0}});var u=n(d,2),h=n(i(u));Y(h,{id:"prompt",children:(v,p)=>{var c=X("Prompt");m(v,c)},$$slots:{default:!0}});var g=n(h,2);Y(g,{id:"prototyping",children:(v,p)=>{var c=X("Prototyping");m(v,c)},$$slots:{default:!0}}),A(()=>R(a,"src",yn)),m(s,e)}var zn=x('<button><span class="trigger-icon svelte-wjh6ga">←</span> <span class="trigger-label svelte-wjh6ga"> </span> <span class="trigger-hint svelte-wjh6ga">Deep Dive</span></button>');function me(s,e){N(e,!1);let t=re(e,"label",8,"Mehr erfahren"),a=re(e,"deepDiveId",8,""),o=re(e,"variant",8,"inline");const d=ct();function l(){d("open",{id:a()})}j();var u=zn(),h=n(i(u),2),g=i(h);A(()=>{Pe(u,1,`deep-dive-trigger ${o()??""}`,"svelte-wjh6ga"),R(u,"aria-label",`Deep Dive öffnen: ${t()??""}`),S(g,t())}),Q("click",u,l),m(s,u),O()}const Dn="/PromptotypingExplainer/assets/vibecoding-Byxduydx.png";var _n=x(`<div class="intro-vibecoding svelte-6bdbz1"><h2 class="svelte-6bdbz1">Frontier-LLMs und Vibe Coding</h2> <div class="research-blog-block svelte-6bdbz1"><p class="svelte-6bdbz1"><!> haben ihre Fähigkeiten in Coding und <!> deutlich verbessert. Modelle wie Claude Opus 4.5, GPT-5.1-Codex und Gemini 3 Pro erreichen auf Benchmarks
      ...
      sein. Ohne Struktur führt es jedoch zu technischen Schulden und Abhängigkeit statt Verständnis.</p> <figure class="vibecoding-figure svelte-6bdbz1"><img alt="Andrej Karpathy Tweet über Vibe Coding" class="vibecoding-image svelte-6bdbz1"/> <figcaption class="svelte-6bdbz1">Andrej Karpathy prägt den Begriff "Vibe Coding" (Februar 2025)</figcaption></figure> <div class="deep-dive-triggers svelte-6bdbz1"><!></div></div></div>`);function En(s,e){N(e,!1);function t(k){xe(k.detail.id)}j();var a=_n(),o=n(i(a),2),d=i(o),l=i(d);Y(l,{id:"frontier-model",children:(k,w)=>{var z=X("Frontier-LLMs");m(k,z)},$$slots:{default:!0}});var u=n(l,2);Y(u,{id:"tool-use",children:(k,w)=>{var z=X("Tool Use");m(k,z)},$$slots:{default:!0}});var h=n(d,2),g=n(i(h));Y(g,{id:"vibe-coding",children:(k,w)=>{var z=X('"Vibe Coding"');m(k,z)},$$slots:{default:!0}});var v=n(h,2),p=i(v),c=n(v,2),f=i(c);me(f,{label:"Vibe Coding Kritik",deepDiveId:"vibe-coding-critique",$$events:{open:t}}),A(()=>R(p,"src",Dn)),m(s,a),O()}var Pn=x(`<div class="intro-strange-minds svelte-5cly7e"><h2 class="svelte-5cly7e">Strange New Minds</h2> <div class="research-blog-block svelte-5cly7e"><p class="svelte-5cly7e"><!> sind "Strange New Minds" (Summerfield, 2025). Weder reine Werkzeuge
      noch echte Intelligenz. Moderne Large Language Models basieren auf der Transformer-Architektur, deren
      Attention-Mechanismus Beziehungen zwischen <!> über große Distanzen
      modelliert. Lindsey et al. (2025) zeigen, dass LLMs während der Textgenerierung simultan multiple abstrakte
      Repräsentationen aktivieren und kombinieren.</p> <p class="svelte-5cly7e">Die heuristische Charakterisierung <!> beschreibt
      LLM-Verhalten, das Eigenschaften zwischen intuitiver Musterassoziation (Kahnemans System 1) und systematischer
      Problemlösung (System 2) zeigt. Die ".42" verweist auf Douglas Adams' Metapher in Per Anhalter durch die
      Galaxis: eine präzise Antwort ohne Kenntnis der eigentlichen Frage. Diese Charakterisierung ist eine
      Arbeitshypothese, keine validierte Theorie.</p> <p class="svelte-5cly7e">Mollicks Konzept der "Co-Intelligence" (2024) bietet einen Rahmen für die Mensch-KI-Kollaboration. <strong class="svelte-5cly7e">Centaur-Arbeit</strong> bedeutet klare Aufgabenteilung: Menschen treffen strategische Entscheidungen,
      KI übernimmt operative Aufgaben. <strong class="svelte-5cly7e">Cyborg-Arbeit</strong> bedeutet enge kognitive Verschränkung:
      Mensch und Maschine entwickeln in iterativen Schleifen gemeinsam Lösungen.</p> <p class="svelte-5cly7e">Ein strukturelles Problem dabei ist <!>: die Tendenz von
      LLMs zur unkritischen Bestätigung von Nutzerannahmen. RLHF belohnt Antworten, die Nutzer als hilfreich bewerten;
      Kritik wird seltener positiv bewertet (Malmqvist, 2024). Anthropics Character Training adressiert dies durch
      epistemische Tugenden wie Neugier, intellektuelle Ehrlichkeit und kritische Reflexion.</p> <div class="deep-dive-triggers svelte-5cly7e"><!></div></div></div>`);function Ln(s,e){N(e,!1);function t(k){xe(k.detail.id)}j();var a=Pn(),o=n(i(a),2),d=i(o),l=i(d);Y(l,{id:"llm",children:(k,w)=>{var z=X("LLMs");m(k,z)},$$slots:{default:!0}});var u=n(l,2);Y(u,{id:"token",children:(k,w)=>{var z=X("Tokens");m(k,z)},$$slots:{default:!0}});var h=n(d,2),g=n(i(h));Y(g,{id:"system-142",children:(k,w)=>{var z=X('"System 1.42"');m(k,z)},$$slots:{default:!0}});var v=n(h,4),p=n(i(v));Y(p,{id:"sycophancy",children:(k,w)=>{var z=X("Sycophancy");m(k,z)},$$slots:{default:!0}});var c=n(v,2),f=i(c);me(f,{label:"System 1.42: Wie (Frontier-)LLMs 'tatsächlich' funktionieren",deepDiveId:"system-1-42",$$events:{open:t}}),m(s,a),O()}var Mn=x(`<div class="intro-kernprinzip svelte-jio7ez"><h2 class="svelte-jio7ez">Das Kernprinzip</h2> <div class="research-blog-block svelte-jio7ez"><p class="core-question svelte-jio7ez"><strong class="svelte-jio7ez">Wie kommuniziert man Domänenwissen so an ein LLM, dass es passende Werkzeuge generiert?</strong></p> <p class="svelte-jio7ez">Nicht das Coden selbst ist die Kernkompetenz, sondern das Wissen darüber, was guter Code für
      ...
      Scholar-Centered Design.</p></div></div>`);function Sn(s){var e=Mn(),t=n(i(e),2),a=n(i(t),4),o=n(i(a));Y(o,{id:"llm",children:(p,c)=>{var f=X("LLMs");m(p,f)},$$slots:{default:!0}});var d=n(a,2),l=n(i(d));Y(l,{id:"critical-expert",children:(p,c)=>{var f=X('"Critical Expert in the Loop"');m(p,f)},$$slots:{default:!0}});var u=n(l,2);Y(u,{id:"sycophancy",children:(p,c)=>{var f=X("Sycophancy");m(p,f)},$$slots:{default:!0}});var h=n(u,2);Y(h,{id:"halluzinationen",children:(p,c)=>{var f=X("Konfabulationen");m(p,f)},$$slots:{default:!0}});var g=n(d,2),v=n(i(g),2);Y(v,{id:"context-engineering",children:(p,c)=>{var f=X("Context Engineering");m(p,f)},$$slots:{default:!0}}),m(s,e)}var $n=x(`<div class="intro-methodik svelte-p6qtke"><div class="content svelte-p6qtke"><h3 class="svelte-p6qtke">Critical Expert in the Loop</h3> <div class="explanation svelte-p6qtke"><p class="svelte-p6qtke">Der Critical Expert in the Loop ist nicht passiver Empfänger, sondern <strong class="svelte-p6qtke">kritischer Validator</strong>.
        ...
        durch systematische Dokumentation, die <!> verhindert und die Informationsdichte maximiert.</p></div> <div class="deep-dive-triggers svelte-p6qtke"><!> <!></div></div></div>`);function Cn(s,e){N(e,!1);function t(p){xe(p.detail.id)}j();var a=$n(),o=i(a),d=n(i(o),8),l=n(i(d),2),u=n(i(l));Y(u,{id:"context-rot",children:(p,c)=>{var f=X("Context Rot");m(p,f)},$$slots:{default:!0}});var h=n(d,2),g=i(h);me(g,{label:"Critical Expert",deepDiveId:"critical-expert",$$events:{open:t}});var v=n(g,2);me(v,{label:"Scholar-Centered Design",deepDiveId:"scholar-centered-design",$$events:{open:t}}),m(s,a),O()}const An="/PromptotypingExplainer/assets/promptotyping-overview-AcSHP9K_.png";var In=x('<div class="phase-item svelte-hawgxw"><div class="phase-number svelte-hawgxw"> </div> <div class="phase-info svelte-hawgxw"><span class="phase-label svelte-hawgxw"> </span> <span class="phase-subtitle svelte-hawgxw"> </span></div></div>'),Fn=x(`<div class="intro-phasen svelte-hawgxw"><h3 class="svelte-hawgxw">Das vierphasige Prozessmodell</h3> <div class="explanation-block svelte-hawgxw"><p class="svelte-hawgxw">Das Phasenmodell strukturiert den Entwicklungsprozess von der ersten Materialsammlung bis zum
      ...
      für die nächste Iteration und führt so zu immer präziseren Prototypen.</p></div></div>`);function Tn(s,e){N(e,!1);const t=ne.filter(v=>v.number!==null);j();var a=Fn(),o=n(i(a),4),d=i(o),l=i(d);oe(l,5,()=>t,de,(v,p)=>{var c=In(),f=i(c),k=i(f),w=n(f,2),z=i(w),$=i(z),E=n(z,2),D=i(E);A(()=>{S(k,r(p).number),S($,r(p).label),S(D,r(p).subtitle)}),m(v,c)});var u=n(d,2),h=i(u),g=i(h);A(()=>R(g,"src",An)),m(s,a),O()}var qn=x(`<div class="phase1-titel svelte-k7vkqd"><header class="scene-header svelte-k7vkqd"><span class="phase-number svelte-k7vkqd">Phase 1</span> <h2 class="svelte-k7vkqd">Vorbereitung</h2> <p class="subtitle svelte-k7vkqd">Materialsammlung</p></header> <div class="content svelte-k7vkqd"><p class="svelte-k7vkqd">Die Vorbereitungsphase hat ein klares Ziel: <strong class="svelte-k7vkqd">alle relevanten Rohmaterialien zusammentragen</strong>,
      ...
      kommentierter Code an kritischen Stellen für spätere Wartung und Anpassung.</p></div></div>`);function ns(s){var e=ts(),t=i(e),a=n(t,2),o=n(i(a),4),d=n(a,2);b(1,t,()=>F,()=>({y:-20,duration:500})),b(1,o,()=>F,()=>({y:20,duration:400,delay:400})),b(1,a,()=>_,()=>({delay:200,duration:400})),b(1,d,()=>_,()=>({delay:500,duration:400})),m(s,e)}var ss=x('<span class="pattern-label svelte-1hq5by1"> </span>'),is=x('<div><!> <div class="bubble svelte-1hq5by1"><p class="svelte-1hq5by1"> </p></div></div>'),rs=x('<div class="typing-indicator svelte-1hq5by1"><span class="typing-dot svelte-1hq5by1"></span> <span class="typing-dot svelte-1hq5by1"></span> <span class="typing-dot svelte-1hq5by1"></span></div>'),as=x('<div class="animated-chat svelte-1hq5by1"><div class="chat-header svelte-1hq5by1"><div class="chat-dots svelte-1hq5by1"><span class="dot svelte-1hq5by1"></span> <span class="dot svelte-1hq5by1"></span> <span class="dot svelte-1hq5by1"></span></div> <span class="chat-title svelte-1hq5by1">Promptotyping Session</span></div> <div class="chat-messages svelte-1hq5by1"><!> <!></div></div>');function ls(s,e){N(e,!1);const t=[{type:"human",pattern:"Context setzen",text:"Lies knowledge.md und requirements.md. Was sind die Story-Gaps im Frontend?"},{type:"llm",pattern:"Reasoning",text:"Ich analysiere die Vault-Dokumente... Drei Gaps: 1) Phase 4 abstrakt, 2) Beispieldaten fehlen, 3) Komponenten ungenutzt."},{type:"human",pattern:"Plan anfordern",text:"Erstelle einen Plan! Wie lösen wir Gap 1?"},{type:"llm",pattern:"Plan",text:"Plan: AnimatedChat-Komponente erstellen → echte Prompts zeigen → Typing-Indicator für Authentizität."},{type:"human",pattern:"Implementieren",text:"Setze den Plan um. Teste ob es kompiliert."},{type:"llm",pattern:"Test",text:"Komponente erstellt. Build erfolgreich. Aber: Beispiel zu generisch für Promptotyping."},{type:"human",pattern:"Feedback",text:"Nimm unseren eigenen Prozess als Meta-Beispiel – das ist authentischer!"},{type:"llm",pattern:"Dokumentation",text:'Chat aktualisiert. Ergänze journal.md: "Meta-Beispiel zeigt echten Workflow".'}];let a=se([]),o=0;Ke(()=>{const v=()=>{if(o<t.length){M(a,[...r(a),t[o]]),o++;const p=t[o-1].type==="human"?2e3:2500;setTimeout(v,p)}else setTimeout(()=>{M(a,[]),o=0,setTimeout(v,1e3)},4e3)};return setTimeout(v,800),()=>{}}),j();var d=as(),l=n(i(d),2),u=i(l);oe(u,1,()=>r(a),de,(v,p)=>{var c=is(),f=i(c);{var k=E=>{var D=ss(),I=i(D);A(()=>S(I,r(p).pattern)),m(E,D)};J(f,E=>{r(p).pattern&&E(k)})}var w=n(f,2),z=i(w),$=i(z);A(()=>{Pe(c,1,`message ${r(p).type??""}`,"svelte-1hq5by1"),S($,r(p).text)}),b(1,c,()=>F,()=>({y:20,duration:400})),m(v,c)});var h=n(u,2);{var g=v=>{var p=rs();b(1,p,()=>_,()=>({duration:200})),m(v,p)};J(h,v=>{r(a).length<t.length&&v(g)})}m(s,d),O()}var os=x(`<div class="phase4-iteration svelte-5lsmoa"><h3 class="svelte-5lsmoa">Der Iterationszyklus</h3> <div class="intro-text svelte-5lsmoa"><p class="svelte-5lsmoa">Der Iterationszyklus ist das Herzstück der Implementation. Er folgt einem klaren Muster: <strong class="svelte-5lsmoa">Context → Reasoning → Plan → Implementation → Test → Feedback → Dokumentation</strong>.
      ...
      ermöglicht der Vault einen nahtlosen Wiedereinstieg.</p></div> <div class="cta svelte-pz9g48"><div class="cta-links svelte-pz9g48"><a href="https://github.com/DigitalHumanitiesCraft/CorrespExplorer" target="_blank" rel="noopener" class="cta-btn svelte-pz9g48">GitHub Repository</a> <a href="https://dhcraft.org/CorrespExplorer" target="_blank" rel="noopener" class="cta-btn cta-btn-secondary svelte-pz9g48">Live Demo</a></div></div></div>`);function xs(s){var e=ws(),t=i(e),a=n(t,2),o=n(a,2),d=n(o,2),l=n(d,2);b(1,t,()=>_,()=>({duration:400})),b(1,a,()=>F,()=>({y:20,duration:500,delay:200})),b(1,o,()=>F,()=>({y:20,duration:500,delay:400})),b(1,d,()=>F,()=>({y:20,duration:500,delay:500})),b(1,l,()=>Qe,()=>({duration:400,delay:600})),m(s,e)}var zs=x('<div class="scroll-indicator svelte-1n46o8q" aria-hidden="true"><div class="scroll-arrow svelte-1n46o8q"></div> <span class="scroll-text svelte-1n46o8q">Scroll</span></div>'),Ds=x('<div class="background-layer svelte-1n46o8q"></div> <!> <main class="scroll-container svelte-1n46o8q"><!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!></main> <!>',1);function _s(s,e){N(e,!1);const t=()=>pe(fe,"$currentPhase",u),a=()=>pe(we,"$currentStep",u),o=()=>pe(Nt,"$globalProgress",u),d=()=>pe(Xe,"$isDeepDiveOpen",u),l=()=>pe(Ze,"$currentDeepDive",u),[u,h]=Ue(),g=se();Ke(()=>(Gt(),setTimeout(()=>{Oe()},300),window.addEventListener("hashchange",Oe),()=>window.removeEventListener("hashchange",Oe)));let v=se(!0);function p(y){y.target.scrollTop>100&&M(v,!1)}function c(y,L,be){return y+(L-y)*be}ye(()=>(t(),a()),()=>{typeof window<"u"&&Ht(t(),a())}),ye(()=>o(),()=>{M(g,(()=>{const y=o();let L;y<.2?L=0:y<.5?L=(y-.2)/.3:y<.85?L=1:L=1-(y-.85)/.15*.3;const be=Math.round(c(96,191,L)),Ae=Math.round(c(125,91,L)),Ie=Math.round(c(139,62,L)),Re=.04+y*.12,Be=30+y*40,We=50-Math.sin(y*Math.PI)*20,Fe=70-y*20;return`radial-gradient(ellipse at ${Be}% ${We}%, rgba(${be}, ${Ae}, ${Ie}, ${Re}) 0%, rgba(232, 232, 232, 1) ${Fe}%)`})())}),Ve(),j();var f=Ds(),k=ge(f),w=n(k,2);on(w,{});var z=n(w,2),$=i(z);nn($,{});var E=n($,2);U(E,{id:"intro-definition",phaseIndex:0,stepIndex:0,children:(y,L)=>{xn(y)},$$slots:{default:!0}});var D=n(E,2);U(D,{id:"intro-vibecoding",phaseIndex:0,stepIndex:1,children:(y,L)=>{En(y,{})},$$slots:{default:!0}});var I=n(D,2);U(I,{id:"intro-strangeminds",phaseIndex:0,stepIndex:2,children:(y,L)=>{Ln(y,{})},$$slots:{default:!0}});var C=n(I,2);U(C,{id:"intro-kernprinzip",phaseIndex:0,stepIndex:3,children:(y,L)=>{Sn(y)},$$slots:{default:!0}});var T=n(C,2);U(T,{id:"intro-methodik",phaseIndex:0,stepIndex:4,children:(y,L)=>{Cn(y,{})},$$slots:{default:!0}});var B=n(T,2);U(B,{id:"intro-phasen",phaseIndex:0,stepIndex:5,children:(y,L)=>{Tn(y,{})},$$slots:{default:!0}});var W=n(B,2);U(W,{id:"phase1-titel",phaseIndex:1,stepIndex:0,children:(y,L)=>{Vn(y,{})},$$slots:{default:!0}});var V=n(W,2);U(V,{id:"phase1-rohdaten",phaseIndex:1,stepIndex:1,children:(y,L)=>{Wn(y,{})},$$slots:{default:!0}});var ie=n(V,2);U(ie,{id:"phase1-sammlung",phaseIndex:1,stepIndex:2,children:(y,L)=>{Nn(y,{})},$$slots:{default:!0}});var ae=n(ie,2);U(ae,{id:"phase2-exploration",phaseIndex:2,stepIndex:0,children:(y,L)=>{Un(y)},$$slots:{default:!0}});var ue=n(ae,2);U(ue,{id:"phase3-titel",phaseIndex:3,stepIndex:0,children:(y,L)=>{Xn(y)},$$slots:{default:!0}});var P=n(ue,2);U(P,{id:"phase3-dokumente",phaseIndex:3,stepIndex:1,children:(y,L)=>{Jn(y)},$$slots:{default:!0}});var Z=n(P,2);U(Z,{id:"phase3-vault",phaseIndex:3,stepIndex:2,children:(y,L)=>{es(y,{})},$$slots:{default:!0}});var K=n(Z,2);U(K,{id:"phase4-titel",phaseIndex:4,stepIndex:0,children:(y,L)=>{ns(y)},$$slots:{default:!0}});var le=n(K,2);U(le,{id:"phase4-iteration",phaseIndex:4,stepIndex:1,children:(y,L)=>{ds(y,{})},$$slots:{default:!0}});var ce=n(le,2);U(ce,{id:"phase4-vault-update",phaseIndex:4,stepIndex:2,children:(y,L)=>{us(y)},$$slots:{default:!0}});var ve=n(ce,2);U(ve,{id:"outro-beispiele",phaseIndex:5,stepIndex:0,children:(y,L)=>{gs(y,{})},$$slots:{default:!0}});var ze=n(ve,2);U(ze,{id:"outro-diskussion",phaseIndex:5,stepIndex:1,children:(y,L)=>{ys(y,{})},$$slots:{default:!0}});var G=n(ze,2);U(G,{id:"outro-zusammenfassung",phaseIndex:5,stepIndex:2,children:(y,L)=>{xs(y)},$$slots:{default:!0}});var ee=n(G,2);{var De=y=>{var L=zs();m(y,L)};J(ee,y=>{r(v)&&y(De)})}var _e=n(z,2);{let y=Ee(()=>(l(),q(()=>l()?.title||""))),L=Ee(()=>(l(),q(()=>l()?.content||"")));vn(_e,{get isOpen(){return d()},get title(){return r(y)},get content(){return r(L)},$$events:{close(...be){Zt?.apply(this,be)}}})}A(()=>Le(k,`background: ${r(g)??""};`)),Q("scroll",z,p),m(s,f),O(),h()}It(_s,{target:document.getElementById("app")});
